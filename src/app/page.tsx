    ...
    <main className="bg-off-white">
        ...
        <section className="flex h-full items-center justify-center px-2 text-white sm:px-[20%] lg:px-[25%]">
          <div className="grid gap-4">
            <div className="relative z-10 col-span-2">
              <h1 className="text-center text-7xl font-bold leading-tight">Texto aqui blah blah blah blah blah blah</h1>
            </div>
      ...
      <div className="overflow-x-clip">
        <div className="relative">
          <svg width="4000" height="44" viewBox="0 0 4000 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute -translate-y-[43px]">
            <path
        ...
        <InfoSegment>
          ...
          <p>
            Sunt voluptate exercitation do labore duis ipsum. Qui occaecat labore labore dolore deserunt irure velit ut. Enim excepteur eu do velit
            incididunt. Sunt adipisicing occaecat exercitation esse eu duis sunt fugiat dolore est. Tempor commodo culpa exercitation minim ipsum
            deserunt quis. Qui adipisicing nisi adipisicing mollit laborum aliquip. Commodo minim nisi ea cupidatat tempor laborum cillum nisi id
            ipsum. Culpa officia enim ut sit minim nostrud sunt proident ex eiusmod.
          </p>
        </InfoSegment>
