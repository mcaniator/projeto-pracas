...
const TableAssessmentComparison = ({
  locations,
  comparisonLocations,
}: {
        ...
        <div className="flex flex-wrap gap-2">
          {comparisonTableLocations.map((comparisonLocation) => (
            <LocationAssessmentSelector
              ...
              selectedAssessmentId={
                selectedAssessmentIds[comparisonLocation.location.id] ?? null
              }
                    ...
                    <tr>
                      <td
                        ...
                        style={buildCategoryLoopStyle({
                          ...
                          isFirstColumn: true,
                          isFirstRow: true,
                          isLastColumn: comparisonTableLocations.length === 0,
                          ...
                          <Fragment key={`subcategory-${child.subcategoryId}`}>
                            ...
                            {child.questions.map((question, questionIndex) => {
                              const isLastSubcategoryQuestion =
                                questionIndex === child.questions.length - 1;
...
export default TableAssessmentComparison;
